...
import QuickLinksOperator from "./QuickLinksOperator"

const columns = [
  { columnKey: "operatorId", label: "#" },
  { columnKey: "operatorCod", label: "Código Operador" },
  { columnKey: "operatorFirstName", label: "Nombres" },
  { columnKey: "operatorLastName", label: "Apellidos" },
  { columnKey: "operatorOccupation", label: "Ocupación" },
  { columnKey: "operatorTurnoName", label: "Turno" },
  { columnKey: "operatorStartTime", label: "Entrada" },
  { columnKey: "operatorEndTime", label: "Salida" },
  { columnKey: "operatorCellphone", label: "Celular" },
  ...
  return (
    <Wrapper className="pb-8">
      <Header
        ...
        $backgroundColor={THEME_COLOR_OPERATORS}
      >
                  ...
                  <TableBody>
                    {list.map((item) => (
                      <TableRow key={item.id}>
                        ...
                        <TableCell>
                          <TableCellLayout>{item.first_name}</TableCellLayout>
                        </TableCell>
                        <TableCell>
                        ...
                        <TableCell>
                          <TableCellLayout>{item.cellphone}</TableCellLayout>
                        </TableCell>
                        <TableCell>
                          <TableCellLayout>
                            <NavLink to={`./${item.id}`}>
