...
const columns = [
  { columnKey: "clientId", label: "#" },
  { columnKey: "clientCod", label: "Código Cliente" },
  { columnKey: "clientFirstName", label: "Nombres" },
  { columnKey: "clientLastName", label: "Apellidos" },
...
export default function ClientList() {
  ...
  return (
    <Wrapper className="pb-8">
      <Header $backgroundColor={THEME_COLOR_CLIENTS}>
        <div className="flex gap-2">
          ...
          <HeaderList
            ...
            theme={{
              COLOR_TITLE: THEME_COLOR_CLIENTS,
              COLOR_SUBTITLE: "#FFF",
            }}
          ></HeaderList>
        </div>
            ...
            {list.length === 0 ? (
              ...
              <>
                ...
                <Pagination
                  ...
                  selectedBackColor={THEME_COLOR_CLIENTS}
                  selectedTextColor={THEME_TEXT_CLIENTS}
