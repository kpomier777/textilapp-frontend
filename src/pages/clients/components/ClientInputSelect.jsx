...
export default function ClientInputSelect({ register, errors, defaultValue }) {
  ...
  return (
    <div className="flex flex-col">
      <label>
        Cliente: <span className="text-rose-700">*</span>
      </label>
      {list ? (
        <>
          {list?.length === 0 ? (
...
ClientInputSelect.propTypes = {
  register: PropTypes.func.isRequired,
  errors: PropTypes.shape().isRequired,
  defaultValue: PropTypes.string,
}

ClientInputSelect.defaultProps = {
  defaultValue: null,
}
