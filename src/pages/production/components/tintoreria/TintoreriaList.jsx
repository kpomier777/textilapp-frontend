...
import { ENTITY_TINTORERIA } from "@/config/entities"
import ModalManager from "../ModalManager"

const columns = [
  { columnKey: "productTintoreriaId", label: "#" },
  { columnKey: "productLote", label: "Producto Lote" },
  { columnKey: "productTintoreriaTina", label: "Tina" },
  { columnKey: "productTintoreriaMachine", label: "Maquina" },
  { columnKey: "productTintoreriaKilosNeto", label: "Peso Neto [kg]" },
  { columnKey: "productTintoreriaKilosLess", label: "Peso Perdido [kg]" },
  { columnKey: "productTintoreriaOperator", label: "Operador" },
  { columnKey: "productTintoreriaClient", label: "Cliente" },
...
export default function ProductTintoreriaList() {
                  ...
                  <TableBody>
                    {list.map((item) => (
                      <TableRow key={item.id}>
                        ...
                        <TableCell>
                          <TableCellLayout>{item.tina_num}</TableCellLayout>
                        </TableCell>
                        <TableCell>
                          <TableCellLayout>
                            <Tooltip
                              content={`${item.machineryName}`}
                              relationship="label"
                            >
                              <NavLink
                                to={`.?view=maquinarias&id=${item.machineryId}`}
                                className="underline text-blue-500"
                              >
                                {item.machineCod}
                              </NavLink>
                        ...
                        <TableCell>
                          <TableCellLayout>{`${item.kilos_less}`}</TableCellLayout>
                        </TableCell>
                        <TableCell>
                          <TableCellLayout>
                            <Tooltip
