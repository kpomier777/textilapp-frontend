...
const columns = [
  { columnKey: "machineryId", label: "#" },
  { columnKey: "machineryCod", label: "Código Maquina" },
  { columnKey: "machineryName", label: "Nombre de la maquina" },
...
export default function MachineryList() {
  ...
  return (
    <Wrapper className="pb-8">
      <Header $backgroundColor={THEME_COLOR_PRODUCTIONS}>
