...
import { ENTITY_HISTORIAL } from "@/config/entities"

const columns = [
  { columnKey: "historialId", label: "#" },
  { columnKey: "historialDate", label: "Fecha" },
  { columnKey: "historialDetail", label: "Detalle" },
]
...
export default function HistorialList() {
  ...
  TextilService.setEntity(ENTITY_HISTORIAL)
                  ...
                  <TableBody>
                    {list.map((item) => (
                      <TableRow key={item.id}>
                        ...
                        <TableCell>
                          <TableCellLayout>{item.detail}</TableCellLayout>
                        </TableCell>
                      </TableRow>
                    ))}
                  </TableBody>
